...
Clear-Host
                       ...
                       Write-Host "4:  Start Automatic Services that are stopped"
                       ...
                       if ($Action -eq '1'){
                                         ...
                                         Nic-options
                                                  ...
                                                  If ($Action -eq '1'){
                                                   ...
                                                   $CorpDCpass =  ConvertTo-SecureString -String (Read-Host "Password") -AsPlainText -Force 
                       ...
                       if ($Action -eq '4'){do
                                             {
                                                ...
                                                "
                                                 ...
                                                 $servers = Get-Content -Path (Read-Host 'file location')
                                                 
                                                 write-host "Please wait........... take a break have a kitkat"
                                                 
                                                 Get-WmiObject Win32_Service -ComputerName $servers -Filter "Name Like '%*%'" |` 
                                                 where     {($_.startmode -like "*auto*") -and ` 
                                                 ($_.state -like "*running*" -notlike "*not running*")}|` 
                                                 select DisplayName,Name,StartMode,State,status|ft -AutoSize
