#///////////////////////////////////////////////////////////////////////////////////
#
#  set-LocalAccountForDevice42.ps1 
#
#  This script configures the local account on a server that has been designated for      
#  the Device42 environment. The local account needs permissions in WMI and remote 
#  management.   
#
#
#///////////////////////////////////////////////////////////////////////////////////
...
$d42User = Get-WmiObject -Class Win32_UserAccount -Filter "LocalAccount=True" | where {$_.Name -clike "*D42Srv"} | Select Name

$d42UserFinal = $d42User | foreach {$_.name}
...
# Permission WMI with Enable Account, Remot Enable and Read Security
  ...
  Set-WmiNamespaceSecurity -namespace root -operation add -account $d42UserFinal -permissions Enable,RemoteAccess,ReadSecurity -allowInherit:$true
