...
$vCenterServerName = "arkpinfvca01.corp.ad.tullib.com" 
...
$FromAddress = "VMwareApacCapacity@tpicap.com"
...
Connect-VIServer -Server $vCenterServerName -Username corp\inavarrete-a -Password "I@n@rif121087"
